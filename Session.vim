...
badd +3299 chunk.pyx
badd +1 glut.py
badd +3068 simple3DGame.py
badd +4 server.py
badd +761 CitySim.py
badd +4272 BattleTank.py
badd +6690 io_export_ogreDotScene.py
badd +4363 Synth.py
badd +729 simpleMultiPlayer.py
badd +8 simpleMultiServer.py
badd +8 run.py
badd +139 shared.py
badd +145 astar.py
badd +41 soundPlayer.py
badd +216 pygletgame.py
badd +92 hangul.py
badd +1 easy_bible.py
badd +29214 easy_bible.txt
badd +49 개역한글판성경.txt
badd +1596 NLT.txt
badd +1 unityGameServer.py
silent! argdel *
set lines=56 columns=155
winpos 0 0
edit unityGameServer.py
...
silent! normal! zE
let s:l = 119 - ((38 * winheight(0) + 27) / 55)
